  ...
  React.useEffect(() => {
    ...
    const prepareTableData = async () => {
      ...
      for (const result of validationData.result) {
        ...
        const temperature = `${ruleDetails.tempLow} C  - ${ruleDetails.tempHigh} C`;
        const insulation = `${ruleDetails.insulationLow} m - ${ruleDetails.insulationHigh} m`;
        const badValue = result.badValue + "m";
